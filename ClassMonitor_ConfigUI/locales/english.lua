...
L.PluginDescription_BURNINGEMBERS = "Display bars with current burning embers value"
L.PluginShortDescription_DEMONICFURY = "Demonic fury"
L.PluginDescription_DEMONICFURY = "Display a bar with current demonic fury value"
